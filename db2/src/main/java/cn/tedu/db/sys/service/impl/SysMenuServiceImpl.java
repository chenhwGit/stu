...
public class SysMenuServiceImpl implements ISysMenuService {
	...
	@Transactional
	public Integer findMenuCount(Integer[] menuIds)
	...
	public SysMenuDO findSysMenuById(Integer id)
		...
		// 调用持久层方法，查询菜单记录
		SysMenuDO sysMenuDO=mapper.getSysMenuById(id);
		// 判断返回值是否为null
		if(sysMenuDO==null) {
	...
	public void modifySysMenu(SysMenuDO sysMenuDO)
			throws EmptyArgumentException, EmptyIdException, ParentNodeNotFoundException,
	...
	public List<MenuNodeVO> findMenuNode()
	...
	public void saveSysMenu(SysMenuDO sysMenuDO)
		...
		sysMenuDO.setCreatedUser(UserUtils.getUsername());
		sysMenuDO.setModifiedUser(UserUtils.getUsername());
	...
	public void removeSysMenu(Integer id) 
		...
		// 删除事务的查询子菜单数量，会不会被阻塞？
		// A - 会   B  -不会
		// mysql默认隔离级别  repeatable read 查询不加锁 和排他锁不互斥
